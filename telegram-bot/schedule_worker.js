...
// 2026-07-13/14: слоты 16:17 и 20:17 временно убирались (подавление раздачи ES, 4→3→2).
// 2026-07-16: ВОССТАНОВЛЕНЫ — подавление разрешилось само, канал снова раздаётся.
// 2026-07-17: 16:17→13:17 (исторически лучший слот по данным, медиана 1358 против 916).
const ES_SLOTS = [[13, 17], [20, 17], [0, 17], [3, 17]];
