...
CONFIGS = {
    ...
    "es": {
        ...
        # Раскладка по Мехико (UTC-6): 16:17→10:17 утро (слабейший слот, 951 ср. против
        # 1108-1260 — но закрывает утренний провал), 20:17→14:17 дневной пик, 00:17→18:17
        # (прайм, серии его замещают), 03:17→21:17 вечерний пик (якорь topical/ig_card).
        # ⚠️ Требует РУЧНОГО включения триггеров ES-1617 и ES-2017 в cron-job.org.
