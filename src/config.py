...
CONFIGS = {
    ...
    "es": {
        ...
        # 2026-07-14: слот 20:17 УБРАН (3→2/день) — ресёрч по shadowban-подавлению: во время
        # активного подавления поток роликов кормит weak-signal данными и ЗАКРЕПЛЯЕТ проблему;
        # меньше, но качественнее и в лучшее время. Оставлены 00:17 (прайм — серии его замещают,
        # total=2 стабильно) и 03:17 (21:17 Мехико = центр вечернего пика, якорь topical/ig_card).
        # ⚠️ Требует РУЧНОГО отключения триггеров ES-1617 И ES-2017 в cron-job.org.
        "daily_slots_utc": [(0, 17), (3, 17)],
