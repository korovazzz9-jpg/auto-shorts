...
CONFIGS = {
    ...
    "es": {
        ...
        # Лимит считал по устаревшей заметке (10 000/день от 28.06), а по факту 18 и 20.08
        # все три канала выдали 12 роликов за день (~25 800 ед.) без единого отказа —
        # увеличение квоты, которое запрашивалось в июне, было одобрено. Квота не потолок.
