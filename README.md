...
| 02:17 | — | Shorts (вечерний прайм Мексики 20:17) |
| 23:00 / 23:17 Вс | Лонгформ (отдельный слот) | Лонгформ (отдельный слот) |

**ES усилен 4-м слотом (02:17 UTC):** ES обгоняет EN по просмотрам/видео при меньшем числе роликов — менее конкурентная ниша. Добавлен вечерний прайм Мексики (20:17 по Мехико), которого не хватало. Следить за `quotaExceeded` в Actions (квота общая на проект); если упрётся — это первый кандидат на откат.
...
| ES канал (Datos en 30s) | ✅ работает, 4 видео/день (усилен — менее конкурентная ниша) |
...
| ES-0200 | daily-es.yml | ежедн | 02:17 | 05:17 |
