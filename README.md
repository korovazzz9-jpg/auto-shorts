...
### Длина Shorts-видео
**28–35 сек (70–88 слов)** — топовые факт-Shorts кластеризуются на 25-35с (по ресёрчу алго-2026: retention/AVD — главный сигнал, >45с резкий спад). Гейт `SCRIPT_MAX_WORDS=90`, голосового CTA нет. edge-tts +5% ≈ 2.6 слова/сек. `TTS_MIN_DURATION=20с` (короткий валидный скрипт не ловит ложный retry).
