...
- **Фоновая музыка** (`_music_layer`/`_build_audio`): случайный луп из `assets/music/*.mp3`, нормализован, зациклен под длину, `MUSIC_LOOP_VOLUME = 0.12`. Старый `_mix_music`/`fetch_random_track` — мёртвый код
